...
@Service
public class ProcessDefinitionRestDSImpl extends ActivitiRestClientAccessor
		implements ProcessDefinitionRestDS {
	private static final Logger LOGGER = LoggerFactory
			.getLogger(ProcessDefinitionRestDSImpl.class);
