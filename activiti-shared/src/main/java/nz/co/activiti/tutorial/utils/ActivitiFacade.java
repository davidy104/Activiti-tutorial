...
public class ActivitiFacade {
	...
	public static class Builder {
		private ActivitiFacade built;

		public Builder(RuntimeService runtimeService, TaskService taskService,
				HistoryService historyService,
				RepositoryService repositoryService,
				IdentityService identityService, FormService formService) {
			built = new ActivitiFacade();
			built.runtimeService = runtimeService;
			built.taskService = taskService;
			built.historyService = historyService;
			built.repositoryService = repositoryService;
			built.identityService = identityService;
			built.formService = formService;
		}

		public ActivitiFacade build() {
			return built;
		}
	}

	public static Builder getBuilder(RuntimeService runtimeService,
			TaskService taskService, HistoryService historyService,
			RepositoryService repositoryService,
			IdentityService identityService, FormService formService) {
		return new Builder(runtimeService, taskService, historyService,
	...
	public List<Task> getAllTasksForGroup(String groupId) {
